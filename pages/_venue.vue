...
export default {
    ...
    head() {
        return {
            title: `${
                this.venueObj ? this.venueObj.name : "Venue"
            } | Color Room Films IN`,
            meta: [
                {
                    property: "og:title",
                ...
                {
                    name: "description",
                    content: `View Indiana’s premier videographers' favorite videos ${
                        this.venueObj ? "from " + this.venueObj.name : ""
                    }. We specialize in cinematic films and making everyone feel like a star.`
                },
                {
                    property: "og-description",
                    content: `View Indiana’s premier videographers' favorite ${
                        this.venueObj ? "from " + this.venueObj.name : ""
                    }. We specialize in cinematic films and making everyone feel like a star.`
                },
                {
                    name: "keywords",
                    content: `${
                        this.venueObj ? this.venueObj.name + ", " : ""
                    } Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN`
                }
            ]
        };
    },
    ...
    created() {
        const match = this.venues.filter(
            venue =>
                venue.slug ===
                this.$route.params.venue.toLowerCase().replace(/\s/g, "")
        );
