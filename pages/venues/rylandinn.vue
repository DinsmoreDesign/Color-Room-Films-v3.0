    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Ryland Inn | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Ryland Inn | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Ryland Inn, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
