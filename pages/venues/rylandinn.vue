<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Ryland Inn" subtitle="...a few special moments" color="dark" />
    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Ryland Inn | Color Room Films IN',
                meta: [
                    { property: 'og:title', content: 'Ryland Inn | Color Room Films IN' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Ryland Inn. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Ryland Inn. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Ryland Inn, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
        ...
        created() {
            ...
            this.updateSelectedVenues([ 'Ryland Inn' ]);
