...
export default {
    ...
    head() {
        return {
            ...
            meta: [
                {
                    property: "og:title",
                    content: "Cape May & Avalon | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite moments at Cape May & Avalon. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Cape May & Avalon, Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
    ...
    created() {
        ...
        this.updateSelectedVenues(["Cape May & Avalon"]);
    },
    methods: {
        ...mapActions({
