<template>
    <div>
        ...
        <!-- Header -->
        <TitleBlock
            title="Clarks Landing Yacht Club"
    ...
    head() {
        return {
            ...
            meta: [
                {
                    property: "og:title",
                    content: "Clarks Landing Yacht Club | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite moments at Clarks Landing Yacht Club. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Clarks Landing Yacht Club, Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
