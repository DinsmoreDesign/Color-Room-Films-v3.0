    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Clarks Landing Yacht Club | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Clarks Landing Yacht Club | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Clarks Landing Yacht Club, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
