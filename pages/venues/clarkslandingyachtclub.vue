<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Clarks Landing Yacht Club" subtitle="...a few special moments" color="dark" />
    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Clarks Landing Yacht Club | Color Room Films IN',
                meta: [
                    { property: 'og:title', content: 'Clarks Landing Yacht Club | Color Room Films IN' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Clarks Landing Yacht Club. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Clarks Landing Yacht Club. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Clarks Landing Yacht Club, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
        ...
        created() {
            ...
            this.updateSelectedVenues([ 'Clarks Landing Yacht Club' ]);
