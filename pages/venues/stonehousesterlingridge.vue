<template>
    <div>
        ...
        <!-- Header -->
        <TitleBlock
            title="Stone House Sterling Ridge"
...
export default {
    ...
    head() {
        return {
            ...
            meta: [
                {
                    property: "og:title",
                    content: "Stone House Sterling Ridge | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite moments at Stone House Sterling Ridge. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Stone House Sterling Ridge, Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
    ...
    created() {
        ...
        this.updateSelectedVenues(["Stone House Sterling Ridge"]);
    },
    methods: {
        ...mapActions({
