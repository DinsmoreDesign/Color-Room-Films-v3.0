    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Windows on the Water Fogbridge | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Windows on the Water Fogbridge | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Windows on the Water Fogbridge, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
