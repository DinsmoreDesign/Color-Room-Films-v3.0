<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Windows on the Water Fogbridge" subtitle="...a few special moments" color="dark" />
...
<script>
    ...
    export default {
        ...
        name: 'WindowsOnTheWaterFogbridge',
        watchQuery: ['page'],
        key: to => to.fullPath,
        transition(to, from) {
        ...
        head() {
            return {
                ...
                title: 'Windows on the Water Fogbridge | Color Room Films IN',
                meta: [
                    { property: 'og:title', content: 'Windows on the Water Fogbridge | Color Room Films IN' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Windows on the Water Fogbridge. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Windows on the Water Fogbridge. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Windows on the Water Fogbridge, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
        ...
        created() {
            ...
            this.updateSelectedVenues([ 'Windows on the Water Fogbridge' ]);
