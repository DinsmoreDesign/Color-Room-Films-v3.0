<template>
    <div>
        ...
        <!-- Header -->
        <TitleBlock
            title="Windows on the Water Fogbridge"
            ...
            meta: [
                {
                    property: "og:title",
                    content:
                        "Windows on the Water Fogbridge | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite moments at Windows on the Water Fogbridge. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Windows on the Water Fogbridge, Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
