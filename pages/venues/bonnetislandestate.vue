    ...
    export default {
        ...
        head() {
            return {
                ...
                meta: [
                    { property: 'og:title', content: 'Bonnet Island Estate | Color Room Films IN' },
                    ...
                    { name: 'keywords', content: 'Bonnet Island Estate, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
