<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Bonnet Island Estate" subtitle="...a few special moments" color="dark" />
    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Bonnet Island Estate | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Bonnet Island Estate | Color Room Films NJ' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Bonnet Island Estate. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Bonnet Island Estate. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Bonnet Island Estate, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
