    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Pleasantdale Chateau | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Pleasantdale Chateau | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Pleasantdale Chateau, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
