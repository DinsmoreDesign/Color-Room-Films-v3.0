    ...
    head() {
        return {
            ...
            meta: [
                {
                    property: "og:title",
                    content: "Pleasantdale Chateau | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite moments at Pleasantdale Chateau. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Pleasantdale Chateau, Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
