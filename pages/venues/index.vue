        ...
        <section>
            <div class="container" style="padding-top: 0;">
                <SelectContainer
                    ...
                    :buttonTitle="
                        venues.length === selectedVenues.length
                            ? 'Unselect All'
                            : 'Select All'
                    "
                    :options="venues"
                    ...
                    @buttonClicked="
                        unselectVenues(venues.length === selectedVenues.length)
                    "
                />
    ...
    head() {
        return {
            ...
            meta: [
                {
                    property: "og:title",
                    content: "Venues | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ favorite venues. We specialize in cinematic films and making everyone feel like a star."
                },
                {
