<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Country Club Weddings" subtitle="...a few special moments" color="dark" />
    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Country Club Weddings | Color Room Films IN',
                meta: [
                    { property: 'og:title', content: 'Country Club Weddings | Color Room Films IN' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Country Club Weddings. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Country Club Weddings. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Country Club Weddings, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
        ...
        created() {
            ...
            this.updateSelectedVenues([ 'Country Club Weddings' ]);
