    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Country Club Weddings | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Country Club Weddings | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Country Club Weddings, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
