<template>
    ...
    <div>
        ...
        <!-- Header -->
            <TitleBlock title="Park Chateau" subtitle="...a few special moments" color="dark" />
    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Park Chateau | Color Room Films IN',
                meta: [
                    { property: 'og:title', content: 'Park Chateau | Color Room Films IN' },
                    { name: 'description', content: 'View New Jersey’s premier videographers’ favorite moments at Park Chateau. We specialize in cinematic films and making everyone feel like a star.' },
                    { property: 'og-description', content: 'View New Jersey’s premier videographers’ favorite moments at Park Chateau. We specialize in cinematic films and making everyone feel like a star.' },
                    { name: 'keywords', content: 'Park Chateau, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues, Fort Wayne, Indiana, IN' }
                ]
        ...
        created() {
            ...
            this.updateSelectedVenues([ 'Park Chateau' ]);
