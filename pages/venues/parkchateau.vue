    ...
    export default {
        ...
        head() {
            return {
                ...
                title: 'Park Chateau | Color Room Films NJ',
                meta: [
                    { property: 'og:title', content: 'Park Chateau | Color Room Films NJ' },
                    ...
                    { name: 'keywords', content: 'Park Chateau, New Jersey, videographer, wedding film, cinematic, motion picture memories, NJ, wedding video, wedding movie, portfolio, contact, special day, venues' }
                ]
