    ...
    <div>
        ...
        <section class="dark">
            <div class="container">
                ...
                <p>
                    The main focus of a wedding is the couple. Our #1 priority
                    is to give you the best and most honest wedding film
                    possible while never getting in the way of the guest's
                    experience. We do this by blending into to the background,
                    normally working behind the photographer, which helps us get
                    the most honest and candid films possible.
                </p>
                <h3>How we work</h3>
                <p>
                    Color Room Films only uses the best gear for the job. To
                    capture our weddings we choose to use 8K cinema cameras. The
                    same cameras that are used on Hollywood sets. No bigger than
                    a shoe box, our cameras aren't intrusive and we never use
                    lights on our couples, making them feel uncomfortable. We
                    only pose couples after the photographer has finished with
                    their portrait session and we'll never ask you to do
                    something you don't want to for the sake of a shot.
                </p>
            </div>
        </section>
    </div>
...
export default {
    ...
    head() {
        return {
            title: "Weddings | Color Room Films IN",
            meta: [
                {
                    property: "og:title",
                    content: "Weddings | Color Room Films IN"
                },
                {
                    name: "description",
                    content:
                        "View Indiana’s premier videographers’ portfolio of recent wedding films. We specialize in cinematic films and making everyone feel like a star."
                },
                {
                ...
                },
                {
                    name: "keywords",
                    content:
                        "Indiana, videographer, wedding film, cinematic, motion picture memories, IN, wedding video, wedding movie, portfolio, contact, special day, Fort Wayne, Indiana, IN"
                }
            ]
        };
    },
